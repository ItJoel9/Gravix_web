...
<head>
    ...
    <title>Red Dead Redemption - Gravix</title>
    <link rel="icon" type="image/png" sizes="32x32" href="logo (2).png">
    <style>
        body {
            font-family: 'Roboto', sans-serif;
            background: url('rdr2b.jpg') no-repeat center center fixed;
    ...
    <div class="content-wrapper">
        ...
        <div class="game-details">
            ...
            <div class="trailer-section">
                <h3>Watch the Gameplay Trailer of Red Dead Redemption</h3>
                <iframe src="https://www.youtube.com/embed/gmA6MrX81z4" title="Red Dead Redemption Gameplay Trailer" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>

            <p>
                Step into the wild west with "Red Dead Redemption." Follow the story of John Marston, a former outlaw seeking redemption in a sprawling open world full of danger, adventure, and breathtaking landscapes.
            </p>
            ...
            <div class="features">
                <h3>Game Features:</h3>
                <ul>
                    <li>Expansive open-world western setting</li>
                    <li>Engaging narrative with rich character development</li>
                    <li>Dynamic and immersive gameplay mechanics</li>
                    <li>Detailed and realistic environments</li>
                    <li>Variety of activities including hunting, dueling, and more</li>
                </ul>
            </div>

            <!-- Add to Cart and Buy Now Buttons -->
            <button class="add-to-cart-button" onclick="addToCart('Red Dead Redemption', 39.99)">Add to Cart</button>
        ...
        <div class="fade-image">
            <img src="rdr2v.jpg" alt="Red Dead Redemption">
        </div>
    </div>

    <script>
        function loadReviews() {
            const reviews = JSON.parse(localStorage.getItem('redDeadReviews')) || [];
        ...
        function addReview() {
            ...
            const reviews = JSON.parse(localStorage.getItem('redDeadReviews')) || [];
            reviews.push(rating);
            localStorage.setItem('redDeadReviews', JSON.stringify(reviews));
            loadReviews();
