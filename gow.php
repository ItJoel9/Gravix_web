...
<head>
    ...
    <title>God of War Ragnarok - Gravix</title>
    <link rel="icon" type="image/png" sizes="32x32" href="logo (2).png">
    <style>
        /* General styles */
        body {
            font-family: 'Roboto', sans-serif;
            background: url('gow1.jpg') no-repeat center center fixed;
    ...
    <div class="content-wrapper">
        ...
        <div class="game-details">
            ...
            <div class="trailer-section">
                <h3>Watch the Gameplay Trailer of God of War</h3>
                <iframe src="https://www.youtube.com/embed/TXukPnO9IdY" title="God of War Gameplay Trailer" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>

            <p>
                Embark on an epic journey as Kratos and Atreus in the Norse realms. Face fearsome enemies, uncover ancient secrets, and witness the fate of gods in this critically acclaimed action-adventure game.
            </p>
            ...
            <div class="features">
                <h3>Game Features:</h3>
                <ul>
                    <li>Stunning Norse mythology-inspired world</li>
                    <li>Fluid combat mechanics with satisfying combos</li>
                    <li>Emotional and gripping narrative</li>
                    <li>Over 40 hours of gameplay</li>
                    <li>New abilities and skills to unlock</li>
                </ul>
            </div>

            <!-- Add to Cart and Buy Now Buttons -->
            <button class="add-to-cart-button" onclick="addToCart('God of War: Ragnarok', 59.99)">Add to Cart</button>
        ...
        <div class="fade-image">
            <img src="thor.jpg" alt="God of War Ragnarok">
        </div>
    </div>
