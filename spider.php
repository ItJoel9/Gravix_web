...
<head>
    ...
    <title>Marvel's Spider-Man - Gravix</title>
    <link rel="icon" type="image/png" sizes="32x32" href="logo (2).png">
    <style>
        /* General styles */
        body {
            font-family: 'Roboto', sans-serif;
            background: url('sp1.jpg') no-repeat center center fixed;
    ...
    <div class="content-wrapper">
        ...
        <div class="game-details">
            ...
            <div class="trailer-section">
                <h3>Watch the Gameplay Trailer of Marvel's Spider-Man</h3>
                <iframe src="https://www.youtube.com/embed/q4GdJVvdxss" title="Marvel's Spider-Man Gameplay Trailer" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>

            <p>
                Swing through the vibrant streets of New York City as Spider-Man. Experience thrilling combat, a gripping story, and a richly detailed open world in this blockbuster action-adventure game.
            </p>
            ...
            <div class="features">
                <h3>Game Features:</h3>
                <ul>
                    <li>Open-world traversal and exploration</li>
                    <li>Dynamic combat with web-swinging mechanics</li>
                    <li>Engaging narrative with memorable characters</li>
                    <li>High-quality graphics and city details</li>
                    <li>Exciting side missions and challenges</li>
                </ul>
            </div>

            <!-- Add to Cart and Buy Now Buttons -->
            <button class="add-to-cart-button" onclick="addToCart('Marvel\'s Spider-Man', 49.99)">Add to Cart</button>
        ...
        <div class="fade-image">
            <img src="sp2.jpg" alt="Spider-Man Alternate Image">
        </div>
    </div>

    <script>
        function loadReviews() {
            const reviews = JSON.parse(localStorage.getItem('spidermanReviews')) || [];
        ...
        function addReview() {
            ...
            const reviews = JSON.parse(localStorage.getItem('spidermanReviews')) || [];
            reviews.push(rating);
            localStorage.setItem('spidermanReviews', JSON.stringify(reviews));
            loadReviews();
