...
<head>
    ...
    <title>Elden Ring - Gravix</title>
    <link rel="icon" type="image/png" sizes="32x32" href="logo (2).png">
    <style>
        body {
            font-family: 'Roboto', sans-serif;
            background: url('eldenb.jpeg') no-repeat center center fixed;
    ...
    <div class="content-wrapper">
        ...
        <div class="game-details">
            ...
            <div class="trailer-section">
                <h3>Watch the Gameplay Trailer of Elden Ring</h3>
                <iframe src="https://www.youtube.com/embed/K_03kFqWfqs" title="Elden Ring Gameplay Trailer" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>

            <p>
                Dive into the mystical world of "Elden Ring" where mythical landscapes, challenging combat, and deep lore await. Journey through a vast open world and face daunting enemies in this epic fantasy adventure.
            </p>
            ...
            <div class="features">
                <h3>Game Features:</h3>
                <ul>
                    <li>Expansive fantasy world with rich lore</li>
                    <li>Intense and rewarding combat system</li>
                    <li>Dynamic weather and day-night cycle</li>
                    <li>Complex character customization</li>
                    <li>Deep narrative with multiple endings</li>
                </ul>
            </div>

            <!-- Add to Cart and Buy Now Buttons -->
            <button class="add-to-cart-button" onclick="addToCart('Elden Ring', 69.99)">Add to Cart</button>
        ...
        <div class="fade-image">
            <img src="eldenv.jpg" alt="Elden Ring">
        </div>
    </div>

    <script>
        function loadReviews() {
            const reviews = JSON.parse(localStorage.getItem('eldenRingReviews')) || [];
        ...
        function addReview() {
            ...
            const reviews = JSON.parse(localStorage.getItem('eldenRingReviews')) || [];
            reviews.push(rating);
            localStorage.setItem('eldenRingReviews', JSON.stringify(reviews));
            loadReviews();
